...
export const nodes :any= {
  ...
  paragraph: {
    ...
    group: 'block',
    parseDOM: [{ tag: 'p' }],
    toDOM (node:any) { return ['p', calcYchangeDomAttrs(node.attrs), 0] }
  },
  ...
  blockquote: {
    ...
    toDOM (node:any) { return ['blockquote', calcYchangeDomAttrs(node.attrs), 0] }
  },
  ...
  heading: {
    ...
    toDOM (node:any) { return ['h' + node.attrs.level, calcYchangeDomAttrs(node.attrs), 0] }
  },
  ...
  code_block: {
    ...
    toDOM (node:any) { return ['pre', calcYchangeDomAttrs(node.attrs), ['code', 0]] }
  },
